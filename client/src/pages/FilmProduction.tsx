...
import { Play, Pause, Volume2, VolumeX, Clapperboard, Film, Blinds, Sun, Moon, ChevronDown, AlertTriangle, Shield, FileText, Check, X, Loader2 } from 'lucide-react';

// Default video data structure (will be populated from content.json)
const getVideoData = (contentData) => ({
  demo: {
    id: 'demo',
    title: 'Demo Reel',
...
const FilmProduction = () => {
  ...
  const VIDEO_DATA = getVideoData(contentData);
